...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2023 at 07:03 AM
...
CREATE TABLE `inventaris` (
  ...
  `tanggal_inventaris` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `inventaris` (`id_inventaris`, `kode_inventaris`, `nama`, `kondisi`, `keterangan`, `jumlah`, `id_jenis`, `tanggal_inventaris`, `id_ruang`, `id_petugas`) VALUES
(1, 'LP001', 'Laptop', 'Baik', 'Bantuan dari Astra Group', 50, 1, '2023-11-02 02:00:02', 1, 1),
(2, 'SP001', 'Spidol', 'Baik', 'Beli menggunakan dana BOS', 100, 2, '2023-11-02 02:00:02', 2, 1),
(3, 'PC001', 'pc', 'baik', 'Baru', 30, 1, '2023-11-02 03:37:00', 1, 1),
(4, 'ac001', 'ac', 'baik', 'bekas', 1, 2, '2023-11-02 03:37:00', 2, 1),
(5, 'kps001', 'kipas', 'baik', 'oke', 1, 1, '2023-11-02 03:37:00', 2, 1),
(13, 'dfgfwef', 'ed', 'Baik', '2fe3f', 22, 1, '2023-11-03 03:55:44', 2, 2);
...
('PMJ001', '2023-11-16 03:55:34', '2023-11-25', '2', 2),
('PMJ002', '2023-11-16 03:54:24', '0000-00-00', '0', 1);
...
(1, 'LAP RPL', 'LAB001', 'LAB RPL STERIDA'),
(2, 'LAB MM', 'LAB001', 'LAB MM STERIDA');
...
--
ALTER TABLE `detail_pinjam`
  MODIFY `id_detail_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
