...
?>
    ...
    ?>
      <div class="alert alert-warning alert-dismissible" role="alert">
        ...
        <strong>Gagal Brohh!!!!</strong> Maaf,Password yang anda masukkan salah.
      </div>
    <?php
    }
  } else {
    ...
    <div div class="alert alert-warning alert-dismissible" role="alert">
      <button button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <strong>Gagal Brohh!!!!</strong> Maaf, Username atau Password yang anda masukkan salah.
    </div>
<?php
  }
}
